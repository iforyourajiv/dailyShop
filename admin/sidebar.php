<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
            ...
            $settingmenu = array('settings.php');
...
?>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					<a href="#" class="nav-top-item <?php if (in_array($filename, $usermenu)): ?> current <?php endif;?> "> <!-- Add the class "current" to current menu item -->
				          Users
					</a>
					<ul>
                         <!-- Add class "current" to sub menu items also -->
						<li><a <?php if ($filename == "users.php"): ?> class="current" <?php endif;?>  href="users.php">Manage User</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li><a <?php if ($filename == "setting.php"): ?> class="current" <?php endif;?> href="settings.php">General</a></li>
					</ul>
				</li>
