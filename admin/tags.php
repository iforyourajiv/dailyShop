...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $noti .= "<div>Tag name Already Exist</div></div>";

    } else {
        $query1 = "INSERT INTO tags(name)VALUE('$name')";
        if (mysqli_query($conn, $query1)) {
            $noti .= "<div class='notification success png_bg'>";
            $noti .= "<a href='#' class='close'><img src='resources/images/icons/cross_grey_small.png' title='Close this notification' alt='close'/></a>";
            $noti .= "<div>Tag Successfully Added</div></div>";
        }
    }
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Tag Name</label>
										<input class="text-input small-input" type="text" id="small-input" name="tag_name" required/>
										<br />
								</p>
